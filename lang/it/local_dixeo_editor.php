...
$string['privacy:metadata:context'] = 'Contenuto del modulo o della diapositiva, struttura del corso e contesto circostante inviati all\'IA per la modifica.';
$string['privacy:metadata:courseid'] = 'L\'identificatore del corso associato all\'attività in modifica.';
$string['privacy:metadata:externalpurpose'] = 'Le istruzioni di modifica e il contenuto dell\'attività vengono inviati all\'API Dixeo per rigenerare o perfezionare il contenuto del modulo. Il plugin non memorizza payload IA in Moodle.';
$string['privacy:metadata:instructions'] = 'Istruzioni di modifica fornite dall\'utente per l\'IA.';
