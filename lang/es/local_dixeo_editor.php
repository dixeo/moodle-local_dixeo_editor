...
$string['editorsessiondiscarded'] = 'Sesión del editor descartada';
$string['editorsessionexpired'] = 'Sesión del editor caducada';
...
$string['eventregeneratecancelled'] = 'Regeneración de módulo Dixeo cancelada';
$string['eventregeneratecancelleddesc'] = 'El usuario con id \'{$a->userid}\' canceló el trabajo de regeneración Dixeo \'{$a->jobid}\' del módulo \'{$a->cmid}\' en el curso \'{$a->courseid}\'.';
$string['eventregeneratecompleted'] = 'Regeneración de módulo Dixeo completada';
$string['eventregeneratecompleteddesc'] = 'El usuario con id \'{$a->userid}\' recibió el trabajo de regeneración Dixeo completado \'{$a->jobid}\' del módulo \'{$a->cmid}\' en el curso \'{$a->courseid}\'.';
$string['eventregeneratestarted'] = 'Regeneración de módulo Dixeo iniciada';
$string['eventregeneratestarteddesc'] = 'El usuario con id \'{$a->userid}\' inició el trabajo de regeneración Dixeo \'{$a->jobid}\' del módulo \'{$a->cmid}\' en el curso \'{$a->courseid}\'.';
...
$string['taskcleanupeditorsessions'] = 'Limpiar sesiones del editor obsoletas';
