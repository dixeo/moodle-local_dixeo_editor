...
$string['privacy:metadata:context'] = 'Contenu du module ou de la diapositive, structure du cours et contexte environnant envoyés à l\'IA pour édition.';
$string['privacy:metadata:courseid'] = 'L\'identifiant du cours associé à l\'activité en cours d\'édition.';
$string['privacy:metadata:externalpurpose'] = 'Les instructions d\'édition et le contenu de l\'activité sont envoyés à l\'API Dixeo pour régénérer ou affiner le contenu du module. Le plugin ne stocke pas les charges IA dans Moodle.';
$string['privacy:metadata:instructions'] = 'Instructions d\'édition fournies par l\'utilisateur pour l\'IA.';
