...
/**
 * Event when an async module content regeneration job is started.
 *
...
/**
 * Fired after a regenerate job is successfully submitted.
 *
 * Includes job id and course module only — no instructions or content.
 */
class regenerate_started extends \core\event\base {
    /**
     * Init method.
     */
    ...
    public static function get_name(): string {
        return get_string('eventregeneratestarted', 'local_dixeo_editor');
    }
    ...
    public function get_description(): string {
        ...
        return get_string('eventregeneratestarteddesc', 'local_dixeo_editor', (object) [
            'userid' => $this->userid,
            'cmid' => $this->objectid,
    ...
    /**
     * Create an event for a started regenerate job.
     *
     * @param \stdClass $cm Course module from get_coursemodule_from_id.
     * @param int $userid User who started regeneration.
